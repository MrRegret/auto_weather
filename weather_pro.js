...
let config = {
    ...
    aqicn_api: "e12d7ab7e84aec0e6aa77c780c5c86cf82ede077", //从http://aqicn.org/data-platform/token/#/ 上申请key填入即可
    huweather_apiKey: "25c63e5d43d64b3d9f2b8de5727944bb", //和风天气APIkey,可自行前往 https://dev.heweather.com/ 进行获取
    lat_lon: "29.00895386,116.69195531", //请填写经纬度,直接从谷歌地图中获取即可
    ...
    show: {
        ...
        template: {
            ...
            detail: `[$[city]$[district]当日天气]
$[weatherIcon]$[weather] $[temperatureMin] ~ $[temperatureMax]°C ☔️降雨概率 $[precipProbability]% 
$[aqiIcon]空气质量 $[aqi]($[aqiDesc]) 🍃风速$[windSpeed]km/h $[windDir]
